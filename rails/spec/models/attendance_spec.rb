...
RSpec.describe Attendance, type: :model do
  ...
  describe "#convert_seconds_to_minutes" do
    ...
    it "59秒を0分に変換する" do
      expect(attendance.send(:convert_seconds_to_minutes, 59)).to eq(0)
    end
  end
  ...
  describe "#set_hourly_wage" do
    ...
    context "土日の場合" do
      let!(:saturday_attendance) { build(:saturday_attendance, user:) }
    ...
    context "日曜日の場合" do
      let!(:sunday_attendance) { build(:sunday_attendance, user:) }
  ...
  describe "#weekend?" do
    context "平日の場合" do
      ...
      it "falseを返す" do
        expect(attendance.send(:weekend?)).to be(false)
      end
    end
    ...
    context "土曜日の場合" do
      ...
      it "trueを返す" do
        expect(saturday_attendance.send(:weekend?)).to be(true)
      end
    end
    ...
    context "日曜日の場合" do
      let!(:sunday_attendance) { build(:sunday_attendance, user:) }
      it "trueを返す" do
        expect(sunday_attendance.send(:weekend?)).to be(true)
      end
    end
  end
  ...
  describe "#calculate_working_minutes" do
    context "13:00に退勤した場合" do
      let!(:attendance) { build(:attendance, :clock_out1300, user:) }
      it "180分を返す" do
    ...
    context "14:01に退勤した場合" do
      let!(:attendance) { build(:attendance, :clock_out1401, user:) }
      it "240分を返す" do
    ...
    context "14:30に退勤した場合" do
      let!(:attendance) { build(:attendance, :clock_out1430, user:) }
      it "240分を返す" do
        expect(attendance.send(:calculate_working_minutes)).to eq(240)
      end
    end
    ...
    context "15:00に退勤した場合" do
      let!(:attendance) { build(:attendance, :clock_out1500, user:) }
      it "240分を返す" do
        expect(attendance.send(:calculate_working_minutes)).to eq(240)
      end
    end
  ...
  describe "#calculate_overtime_minutes" do
    ...
    context "14:29に退勤した場合" do
      let!(:attendance) { build(:attendance, :clock_out1429, user:) }
      it "29分を返す" do
    ...
    context "14:31に退勤した場合" do
      let!(:attendance) { build(:attendance, :clock_out1431, user:) }
      it "31分を返す" do
    ...
    context "14:59に退勤した場合" do
      let!(:attendance) { build(:attendance, :clock_out1459, user:) }
      it "59分を返す" do
  ...
  describe "#calculate_daily_wage" do
    ...
    context "土曜日の場合" do
      context "13:00に退勤した場合" do
        let!(:saturday_attendance) { build(:saturday_attendance, :clock_out1300, user:) }
      ...
      context "15:00に退勤した場合" do
        let!(:saturday_attendance) { build(:saturday_attendance, :clock_out1500, user:) }
    ...
    context "日曜日の場合" do
      context "13:00に退勤した場合" do
        let!(:sunday_attendance) { build(:sunday_attendance, :clock_out1300, user:) }
      ...
      context "15:00に退勤した場合" do
        let!(:sunday_attendance) { build(:sunday_attendance, :clock_out1500, user:) }
  ...
  describe "#calculate_overtime_pay" do
    ...
    context "土曜日の場合" do
      ...
      context "14:01に退勤した場合" do
        let!(:saturday_attendance) { build(:saturday_attendance, :clock_out1401, user:) }
      ...
      context "14:29に退勤した場合" do
        let!(:saturday_attendance) { build(:saturday_attendance, :clock_out1429, user:) }
      ...
      context "14:30に退勤した場合" do
        let!(:saturday_attendance) { build(:saturday_attendance, :clock_out1430, user:) }
      ...
      context "14:31に退勤した場合" do
        let!(:saturday_attendance) { build(:saturday_attendance, :clock_out1431, user:) }
      ...
      context "14:59に退勤した場合" do
        let!(:saturday_attendance) { build(:saturday_attendance, :clock_out1459, user:) }
    ...
    context "日曜日の場合" do
      ...
      context "14:01に退勤した場合" do
        let!(:sunday_attendance) { build(:sunday_attendance, :clock_out1401, user:) }
      ...
      context "14:29に退勤した場合" do
        let!(:sunday_attendance) { build(:sunday_attendance, :clock_out1429, user:) }
      ...
      context "14:30に退勤した場合" do
        let!(:sunday_attendance) { build(:sunday_attendance, :clock_out1430, user:) }
      ...
      context "14:31に退勤した場合" do
        let!(:sunday_attendance) { build(:sunday_attendance, :clock_out1431, user:) }
      ...
      context "14:59に退勤した場合" do
        let!(:sunday_attendance) { build(:sunday_attendance, :clock_out1459, user:) }
